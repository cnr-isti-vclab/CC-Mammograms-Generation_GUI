...
load('', 'a_tot'); % Insert here the path of the file a_tot.mat
a = a_tot;
load('', 'b_tot'); % Insert here the path of the file b_tot.mat
b = b_tot;
load('', 'phi_tot'); % Insert here the path of the file phi_tot.mat
phi = phi_tot;
load('', 'X0_tot'); % Insert here the path of the file X0_tot.mat
X0 = X0_tot;
load('', 'Y0_tot'); % Insert here the path of the file Y0_tot.mat
Y0 = Y0_tot;
load('', 'Alpha_e_tot'); % Insert here the path of the file Alpha_e_tot.mat
Alpha_e = Alpha_e_tot;
%%%%%----------------------------%%%%%%%
...
TextH_glandular_tissue = uicontrol('style','text', 'FontSize', 9, ...
    'BackgroundColor',background_color, ...
    'position',[left_sn+width_s/6+30 start_bottom_s-5.92*delta-height_s 2*width_s/3 height_s]);
...
second_checkbox.String='<html>&nbsp Submit<br /> &nbsp Glandular<br /> &nbsp Tissue</html>';
